...
- **[Principles](Principles.md)** — The foundational beliefs and product mindset that drive every decision.
- **[Goal-Setting Framework](Goal-Setting.md)** — Mission, OKRs, and Initiatives — how strategic direction connects to work in repositories.
- **[Issue Format](Issue-Format.md)** — The three-section issue structure, formatting rules, and labels.
- **[Issue Hierarchy](Issue-Hierarchy.md)** — Epic / PBI / Task — the three operational levels tracked via GitHub sub-issues.
